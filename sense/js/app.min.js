...
if (document.querySelector('.slider-office__body')) {
	new Swiper('.slider-office__body', {
		/*
		effect: 'fade',
		autoplay: {
			delay: 3000,
...
if (document.querySelector('.slider-recruiter__body')) {
	new Swiper('.slider-recruiter__body', {
		/*
		effect: 'fade',
		autoplay: {
			delay: 3000,
...
document.getElementById('foter-faq__img').onclick = function() {
	document.querySelector('.foter-faq__img').classList.toggle("_active");
	document.querySelector('.footer-faq__body').classList.toggle("_active");
  }

  document.getElementById('contacts-body__btn').onclick = function() {
	document.querySelector('.foter-faq__img').classList.toggle("_active");
	document.querySelector('.footer-faq__body').classList.toggle("_active");
  }
